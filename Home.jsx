...
export default class Home extends React.Component {
    ...
    handleUpdate(_id) {
        ...
        this.props.dispatch(fixProduct({
            _id, name: name, id: id, price: price,
            ...
            <div class="container">
                ...
                {this.props.products.map((i) =>
                    ...
                    <div class="list">
                        ...
                        <img class="image1" src={i.imageUrl} />
                        <br />
                        <div class="footer">
                            ...
                            <input type='button' class="button" value='View' onClick={() => this.handleView(i._id)} />
                        </div>
